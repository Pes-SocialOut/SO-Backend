...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['date_hour'], ['date_hour.date_hour'], ),
    sa.ForeignKeyConstraint(['pollutant_composition'], ['polutant.composition'], ),
...
def downgrade():
    ...
    op.drop_table('polutant')
    op.drop_table('date_hour')
