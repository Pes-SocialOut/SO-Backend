...
from app.module_airservice.controllers import baricentric_interpolation
...
class TestTriangulationAlgorithmSuite:
    ...
    def test_baricentric_interpolation_on_v0(self):
        # Arrange
        v0x = 0; v0y = 0
        v1x = 1; v1y = 3
        v2x = 5; v2y = 1
        px  = 0; py  = 0
        # Action
        w0, w1, w2 = baricentric_interpolation(v0x, v0y, v1x, v1y, v2x, v2y, px, py)
        # Assert
        assert w0 == 1
        assert w1 == 0
        assert w2 == 0
    
    def test_baricentric_interpolation_on_v1(self):
        # Arrange
        v0x = 0; v0y = 0
        v1x = 1; v1y = 3
        v2x = 5; v2y = 1
    ...
    def test_baricentric_interpolation_on_v2(self):
        # Arrange
        v0x = 0; v0y = 0
        v1x = 1; v1y = 3
        v2x = 5; v2y = 1
    ...
    def test_baricentric_interpolation_on_v0_v1_mean(self):
        # Arrange
        v0x = 0; v0y = 0
        v1x = 1; v1y = 3
        v2x = 5; v2y = 1
    ...
    def test_baricentric_interpolation_on_v0_v2_mean(self):
        # Arrange
        v0x = 0; v0y = 0
        v1x = 1; v1y = 3
        v2x = 5; v2y = 1
    ...
    def test_baricentric_interpolation_on_v1_v2_mean(self):
        # Arrange
        v0x = 0; v0y = 0
        v1x = 1; v1y = 3
        v2x = 5; v2y = 1
    ...
    def test_baricentric_interpolation_on_baricenter(self):
        # Arrange
        v0x = 0; v0y = 0
        v1x = 1; v1y = 3
        v2x = 5; v2y = 1
